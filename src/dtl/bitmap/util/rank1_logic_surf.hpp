...
/* Note from Marcellus: Here I just changed the default granularity to 64, for ease of testing.
I wanted to have it lower but granularity can only be a multiple of the word_bitlength and
...
template<
    ...
    u1 _inclusive = false,
    /// The granularity of the rank lookup table. original: 512
